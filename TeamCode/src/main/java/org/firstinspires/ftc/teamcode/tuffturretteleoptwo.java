...
@TeleOp(name="triple t teleop 2", group="Robot")
public class tuffturretteleoptwo extends LinearOpMode {
...
//                            powerCmd = 0.0;
                ...
                nearMotor.setPower(0.4);
                farMotor.setPower(0.4);
            } //else {
//                nearMotor.setPower(0);
//                farMotor.setPower(0);
//                //  transferGate.setPosition(closed);
//            }
    ...
    int calcVelo(double ty, double ta) {
        ...
        if (nearMotor.getVelocity() < idleVelo) //if ts doesnt work do !gamepad1.square
            return 200; //also maybe move it outside of calcvelo n instead do whileopmodeisactive if shootingisnotpressed
        return 1350;
