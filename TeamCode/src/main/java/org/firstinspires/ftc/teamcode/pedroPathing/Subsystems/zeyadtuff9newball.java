...
@Autonomous(name = "Zeyad RED FINAL OMG TUFFF TS ", group = "Autonomous")
@Configurable // Panels
public class zeyadtuff9newball extends OpMode {
    ...
    public void buildPaths(Follower follower) {
        startToShoot = follower
                ...
                .setLinearHeadingInterpolation(Math.toRadians(270), Math.toRadians(222))
                .build();
