...
@TeleOp(name="Main TeleOp Base Test", group="Robot")
public class testteleopbase extends LinearOpMode {
    private com.qualcomm.hardware.limelightvision.Limelight3A limelight;

    private int tolerance = 70;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            if (shoot) {
                ...
                if (targetVelocity - currentVelocity < tolerance -50){
                    shootingSafe = true;
                    //  transfer.setPower(1);
                }
